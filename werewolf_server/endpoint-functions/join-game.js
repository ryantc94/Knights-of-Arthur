...
const createPlayer = (username, role, team) => {
  new Player({
    ...
    socket.emit('player-confirm', {playerInfo: player, loginSuccess: true})
    socket.broadcast.emit('player-confirm', {playerInfo: player, loginSuccess: true})
  });
}
